...
namespace UHFPS.Runtime
{
    public class LanternItem : PlayerItemBehaviour
    {
        ...
        public Percentage FuelLowPercent = 20;
        public Color NormalFuelColor = Color.white;
        ...
        private Image lanternIcon;
        private Image lanternFill;
        ...
        private void Awake()
        {
            ...
            lanternIcon = (Image)behaviours[1];
            lanternFill = (Image)behaviours[2];
            ...
            if (!SaveGameManager.GameWillLoad)
            {
                ...
                fuelColor = lanternFuel > FuelLowPercent.Ratio()
                    ? NormalFuelColor : LowFuelColor;

                lanternIcon.color = fuelColor;
            }
        }
        ...
        public override void OnUpdate()
        {
            ...
            if (isEquipped && !isBusy && !InfiniteFuel)
            {
                ...
                // lantern icon
                fuelColor = lanternFuel > FuelLowPercent.Ratio()
                    ? Color.Lerp(fuelColor, NormalFuelColor, Time.deltaTime * 10)
                    : Color.Lerp(fuelColor, LowFuelColor, Time.deltaTime * 10);
        ...
        private void UpdateFuel()
        {
            ...
            lanternFill.fillAmount = lanternFuel;
        }
