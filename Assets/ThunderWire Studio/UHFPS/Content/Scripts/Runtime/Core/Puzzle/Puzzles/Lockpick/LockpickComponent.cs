...
namespace UHFPS.Runtime
{
    public class LockpickComponent : MonoBehaviour
    {
        ...
        private void UnuseLockpick()
        {
            ...
            playerPresence.GameManager.LockInput(false);
            playerPresence.GameManager.SetBlur(false, true);
            playerPresence.GameManager.ShowPanel(GameManager.PanelType.MainPanel);
            playerPresence.GameManager.ShowControlsInfo(false, string.Empty);
            Destroy(gameObject);
        }
