...
namespace UHFPS.Editors
{
    ...
    public class ManagerModulesAssetEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            serializedObject.Update();
            {
                ...
                for (int i = 0; i < ManagerModules.arraySize; i++)
                {
                    ...
                    UnityEngine.Object module = moduleProperty.objectReferenceValue;
        ...
        {
            ScriptableObject module = CreateInstance((Type)type);
            module.name = module.GetType().Name;
            Undo.RegisterCreatedObjectUndo(module, "Add Manager Module");

            if (EditorUtility.IsPersistent(target))
                AssetDatabase.AddObjectToAsset(module, target);

            ManagerModules.arraySize++;
            SerializedProperty element = ManagerModules.GetArrayElementAtIndex(ManagerModules.arraySize - 1);
            element.objectReferenceValue = module;
